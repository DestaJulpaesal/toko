    ...
    <footer className="public-footer">
      <div className="footer-main">
        ...
        <div className="footer-links">
          <div><strong>Jelajahi</strong><Link to="/products">Produk</Link><Link to="/parsel">Parsel</Link><Link to="/paket-acara">Paket Acara</Link><Link to="/promo">Promo</Link><Link to="/testimoni">Testimoni</Link></div>
